...
gulp.task('fileinclude', function() {
    ...
    var injectFiles = gulp.src(['build/Assets/styles/build.css', 'build/Assets/scripts/build.js']);
...
gulp.task('scripts', function(){
    return gulp.src([
        ...
        .pipe(babel({ presets: ['es2015-ie'] })) // #3. transpile ES2015 to ES5 using ES2015 preset
        .pipe(uglify())
...
gulp.task('default', function (callback) {
	runSequence(['fileinclude', 'styles', 'scripts', 'browserSync', 'watch'],
		callback
	)
})